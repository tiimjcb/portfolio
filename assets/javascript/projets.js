document.addEventListener('DOMContentLoaded', () => {
    ...
    const projects = [
        ...
        },
        {
            ...
            openDescription: "Projet personnel.<br>Développement de <i>Free Smiley Dealer Bot Revived</i>, un bot Discord envoyant d'affreux emojis : le merveilleux résultat d'un mème (Free Smiley Faces)",
            openDescriptionEN: "Personal project.<br>Developed from scratch <i>Free Smiley Dealer Bot Revived</i>, a Discord bot sending awful emojis: the wonderful result of a meme (Free Smiley Faces)",
            footerText: "Compétences renforcées : Python, Discord API, SQLite",
            footerTextEN: "Skills improved: Python, Discord API, SQLite",
            icon: "/assets/icons/fsdSmile.png",
            hasGitRepo: true,
